...
<body class="four-zero-four">
    <div class="four-zero-four-container">
        ...
        <div class="error-message">Essa página não existe</div>
        <div class="button-place">
            <a href="<?php echo $url.'dashboard' ?>" class="btn btn-default btn-lg waves-effect">VOLTAR PARA PÁGINA INICIAL</a>
        </div>
    </div>
